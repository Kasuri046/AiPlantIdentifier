...
class _BuildSpinnerState extends State<HexagonDots> with SingleTickerProviderStateMixin {
          ...
          child: _animationController.value <= 0.28
              ? Stack(
                  ...
                  children: <Widget>[
                    ...
                    _buildInitialDot(angle60 + angle30, const Interval(0.04, 0.12)),
                    _buildInitialDot(angle120 + angle30, const Interval(0.08, 0.16)),
                    _buildInitialDot(angle180 + angle30, const Interval(0.12, 0.20)),
                    _buildInitialDot(angle240 + angle30, const Interval(0.16, 0.24)),
                    _buildInitialDot(angle300 + angle30, const Interval(0.20, 0.28)),
                  ],
                )
              : Transform.rotate(
